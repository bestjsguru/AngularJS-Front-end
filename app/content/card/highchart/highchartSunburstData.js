...
export default class HighchartSunburstData extends HighchartData {
    ...
    generate() {
        ...
        if(!this.metrics.length) {
            this.setError('Sunburst diagrams must have at least one visible metric');
    ...
    setSingleMetricColors() {
        this.chartOptions.series.forEach(serie => {
            // In case when there is a single metric with no custom color we want to convert sunburst to
